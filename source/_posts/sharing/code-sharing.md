...
This is a post with interesting and useful code that will help programming. Most of them are from the internet, and credits are in the comments of the code.

## C# Execute a Program In Memory

With `unsafe`, C# can do bunch of wierd things. Useful in games or secret programs.
...
Removing C/C++ style comments in Python.
